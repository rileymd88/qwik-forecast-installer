...
class App: 
    ...
    def install(self):
        ...
        try:
            ...
            install_directory = os.getcwd().split('gui')[0] + '\code\dist\__main__.exe'
            bat_file = os.getcwd().split('gui')[0] + '\code\gui\install.bat'
            subprocess.call([bat_file, self.name_entry.get(), install_directory], shell=False)           
